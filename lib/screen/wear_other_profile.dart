...
class WearOtherProfileScreen extends StatefulWidget {
  const WearOtherProfileScreen({Key? key}) : super(key: key);

  @override
  State<WearOtherProfileScreen> createState() => _WearOtherProfileScreenState();
}

class _WearOtherProfileScreenState extends State<WearOtherProfileScreen> {
                              ...
                              Column(
                                children: [
                                  ...
                                  SizedBox(
                                    width: width * 0.6,
                                    child:
                                        snapshot.data!.user!.isFollowed != true
                                            ? ElevatedButton(
