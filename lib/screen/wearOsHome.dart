...
class WearHomepageScreen extends StatefulWidget {
  const WearHomepageScreen({Key? key}) : super(key: key);

  @override
  State<WearHomepageScreen> createState() => _WearHomepageScreenState();
}

class _WearHomepageScreenState extends State<WearHomepageScreen> {
  String? image;
  bool? isLiked;
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    Align(
                                      ...
                                      child:
                                          Text(lstPost[index]["tweetContent"]!),
                                    ),
                                    Container(
                                      child: lstPost[index]["images"].length !=
                                              0
                                          ? Image.network(
